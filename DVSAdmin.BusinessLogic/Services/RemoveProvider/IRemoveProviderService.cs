...
namespace DVSAdmin.BusinessLogic.Services
{
    public interface IRemoveProviderService
    {
        ...
        public Task<GenericResponse> UpdateProviderStatus(ProviderProfile providerProfile, string loggedInUserEmail, EventTypeEnum eventType, TeamEnum team = TeamEnum.DSIT);
